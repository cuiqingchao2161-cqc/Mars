...
JNIEXPORT void JNICALL Java_com_tencent_mars_xlog_Xlog_logBytes(JNIEnv* env,
                                                                jclass,
                                                                jlong _log_instance_ptr,
                                                                int _level,
                                                                jstring _tag,
                                                                ...
                                                                jint _offset,
                                                                jint _length) {
    if (NULL == _data || _offset < 0 || _length <= 0) {
        return;
    }

    jsize data_len = env->GetArrayLength(_data);
    if (_offset > data_len || _length > data_len - _offset) {
        return;
    }
    ...
    jbyte* bytes = env->GetByteArrayElements(_data, NULL);
    if (NULL != bytes) {
        mars::xlog::XloggerWriteBytes(_log_instance_ptr, &xlog_info, bytes + _offset, (size_t)_length);
        env->ReleaseByteArrayElements(_data, bytes, JNI_ABORT);
    }
...
JNIEXPORT jlong JNICALL Java_com_qx_qylog_Xlog_newXlogInstance(JNIEnv* env, jobject obj, jobject log_config) {
    return Java_com_tencent_mars_xlog_Xlog_newXlogInstance(env, obj, log_config);
}

JNIEXPORT jlong JNICALL Java_com_qx_qylog_Xlog_getXlogInstance(JNIEnv* env, jobject obj, jstring nameprefix) {
    return Java_com_tencent_mars_xlog_Xlog_getXlogInstance(env, obj, nameprefix);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_releaseXlogInstance(JNIEnv* env, jobject obj, jstring nameprefix) {
    Java_com_tencent_mars_xlog_Xlog_releaseXlogInstance(env, obj, nameprefix);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_appenderOpen(JNIEnv* env, jclass clazz, jobject log_config) {
    Java_com_tencent_mars_xlog_Xlog_appenderOpen(env, clazz, log_config);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_appenderClose(JNIEnv* env, jobject obj) {
    Java_com_tencent_mars_xlog_Xlog_appenderClose(env, obj);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_appenderFlush(JNIEnv* env,
                                                            jobject obj,
                                                            jlong log_instance_ptr,
                                                            jboolean is_sync) {
    Java_com_tencent_mars_xlog_Xlog_appenderFlush(env, obj, log_instance_ptr, is_sync);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_logWrite(JNIEnv* env, jclass clazz, jobject log_info, jstring log) {
    Java_com_tencent_mars_xlog_Xlog_logWrite(env, clazz, log_info, log);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_logWrite2(JNIEnv* env,
                                                        jclass clazz,
                                                        jlong log_instance_ptr,
                                                        int level,
                                                        jstring tag,
                                                        ...
                                                        jlong maintid,
                                                        jstring log) {
    Java_com_tencent_mars_xlog_Xlog_logWrite2(env,
                                              clazz,
                                              log_instance_ptr,
                                              level,
                                              tag,
...
JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_logBytes(JNIEnv* env,
                                                       jclass clazz,
                                                       jlong log_instance_ptr,
                                                       int level,
                                                       jstring tag,
                                                       ...
                                                       jint offset,
                                                       jint length) {
    Java_com_tencent_mars_xlog_Xlog_logBytes(env, clazz, log_instance_ptr, level, tag, data, offset, length);
}

JNIEXPORT jint JNICALL Java_com_qx_qylog_Xlog_getLogLevel(JNIEnv* env, jobject obj, jlong log_instance_ptr) {
    return Java_com_tencent_mars_xlog_Xlog_getLogLevel(env, obj, log_instance_ptr);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_setLogLevel(JNIEnv* env,
                                                          jobject obj,
                                                          jlong log_instance_ptr,
                                                          jint log_level) {
    Java_com_tencent_mars_xlog_Xlog_setLogLevel(env, obj, log_instance_ptr, log_level);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_setAppenderMode(JNIEnv* env,
                                                              jobject obj,
                                                              jlong log_instance_ptr,
                                                              jint mode) {
    Java_com_tencent_mars_xlog_Xlog_setAppenderMode(env, obj, log_instance_ptr, mode);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_setConsoleLogOpen(JNIEnv* env,
                                                                jobject obj,
                                                                jlong log_instance_ptr,
                                                                jboolean is_open) {
    Java_com_tencent_mars_xlog_Xlog_setConsoleLogOpen(env, obj, log_instance_ptr, is_open);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_setMaxFileSize(JNIEnv* env,
                                                             jobject obj,
                                                             jlong log_instance_ptr,
                                                             jlong max_size) {
    Java_com_tencent_mars_xlog_Xlog_setMaxFileSize(env, obj, log_instance_ptr, max_size);
}

JNIEXPORT void JNICALL Java_com_qx_qylog_Xlog_setMaxAliveTime(JNIEnv* env,
                                                              jobject obj,
                                                              jlong log_instance_ptr,
                                                              jlong max_time) {
    Java_com_tencent_mars_xlog_Xlog_setMaxAliveTime(env, obj, log_instance_ptr, max_time);
}
}
