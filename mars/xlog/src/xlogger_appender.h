...
class XloggerAppender {
 public:
    ...
    void WriteBytes(const XLoggerInfo* _info, const void* _data, size_t _len);
 ...
 private:
    ...
    void __WriteRawSync(const void* _data, size_t _len);
    void __WriteRawAsync(const void* _data, size_t _len, const XLoggerInfo* _info);
